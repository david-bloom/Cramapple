...
export function HintGate({ name, cost, state = 'idle', onAsk, onConfirm, onCancel, onHide, children }) {
    ...
    return (
      <div>
        <div style={{
          ...
          {onHide && <button type="button" onClick={onHide} style={{ ...linkBtn, padding: 0, fontSize: 'var(--type-count-size)' }}>Hide</button>}
        </div>

...
**Status:** Partially Decided (DECISION-0069, 2026-09-26)
...
- [x] Set subject launch price — $39.99 per subject, $79.99 for a 2-subject bundle, $99.99 for a
      3-subject bundle. See `DECISION-0069`. Unlimited-tier pricing not yet confirmed (built catalog
      currently has it at $139.99). The 2-bundle price carries essentially no discount vs. two singles
      ($79.98) — flagged in `DECISION-0069` as needing confirmation, not yet resolved.
...
- [ ] Prevent sales of subject bundles before each pack passes quality gates. Day-1 subjects are AP
      Biology and AP Statistics (`DECISION-0069`) — a Biology+Statistics bundle cannot be sold until

...
| `TASK-0010` | Grader Confidence and Calibration | Critical | Approved (2026-07-12), execution in progress | Learning Quality and Product Owner release gates (acceptance criteria open) |

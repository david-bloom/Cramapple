# Cramapple Content & Pedagogy — canonical

The copy rules and the pedagogy rules. The second set are design rules, not suggestions: a screen that breaks them is wrong even if it looks right.

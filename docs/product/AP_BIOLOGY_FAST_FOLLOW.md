...
| ~~**FF-3**~~ | Unit-gated path dark product-wide (8 items across 10 subjects) | **Mostly CLOSED 2026-09-24 (DECISION-0066)** — promoted 229 existing two-model-agreed serving labels to `validated` (content unedited since label creation, verified per-item, not assumed) across 9 subjects. Unit-gated servable jumped **8 → 143** product-wide: Biology 23, Chemistry 44, Precalculus 27, Statistics 28 (older pack only — see the Statistics gap below), Calc AB 7, Physics 1 7, Physics 2 2, Calc BC 4 (unchanged), Physics C E&M 1. Self-test 93/93 clean, 0 mismatch after. **Still dark: Physics C Mechanics** (0 of 4 candidates were fresh — all republished since labeling) **and Calc BC** (0 of 17 fresh) — both need fresh relabeling, not promotion, to open | Claude (executed); Codex (relabeling for the 2 still-dark subjects) | — |

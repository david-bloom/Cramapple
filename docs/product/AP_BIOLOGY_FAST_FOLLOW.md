...
| **FF-3** | Unit-gated path dark product-wide (8 items across 10 subjects) | **High, strategic** | Claude | **Decided 2026-09-24 (DECISION-0066)** — two-model agreement approved as sufficient for `validated`, David as approver of record via `automated_spot_check`. Executing promotion where agreement data already exists |

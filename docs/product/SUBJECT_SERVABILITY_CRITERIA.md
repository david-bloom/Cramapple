...
| AP Physics 1 | Measured 2026-09-25, work order written, not yet run. Largest canonical gap of any subject: 39/61 FRQ (64%) missing, 115/124 labels non-validated, 0/124 difficulty. | `prompts/CODEX_WORK_ORDER_AP_PHYSICS_1_LAUNCH_READINESS_2026_09_25.md` |
| AP Physics 2 | Measured 2026-09-25, work order written, not yet run. 19/37 FRQ (51%) missing canonicals, 69/79 labels non-validated, 0/79 difficulty. | `prompts/CODEX_WORK_ORDER_AP_PHYSICS_2_LAUNCH_READINESS_2026_09_25.md` |
| AP Physics C: Mechanics | Measured 2026-09-25, work order written, not yet run (canonicals + difficulty only — labels already covered by the pre-existing, not-yet-run FF-3/DECISION-0066 relabel order). 29/42 FRQ (69%) missing canonicals, 0/84 difficulty. | `prompts/CODEX_WORK_ORDER_AP_PHYSICS_C_MECHANICS_LAUNCH_READINESS_2026_09_25.md`, `prompts/CODEX_WORK_ORDER_PHYSICS_C_MECH_AND_CALC_BC_RELABEL_2026_09_24.md` |
| AP Physics C: E&M | Measured 2026-09-25, work order written, not yet run — no pre-existing label order exists for this subject (only Mechanics/Calc BC were covered by FF-3). 39/55 FRQ (71%, tied-largest fraction) missing canonicals, 97/103 labels non-validated, 0/103 difficulty. | `prompts/CODEX_WORK_ORDER_AP_PHYSICS_C_EM_LAUNCH_READINESS_2026_09_25.md` |

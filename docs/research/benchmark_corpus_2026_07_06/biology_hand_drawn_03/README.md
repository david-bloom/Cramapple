# Root Tip Mitotic Index Across Four Temperature Treatments

**Package:** `biology_hand_drawn_03`
**Subject:** AP Biology
**Answer type:** Hand-drawn graph response
**Source item:** `HDG-2026-P2-CAT-004` (reused from the existing in-repo

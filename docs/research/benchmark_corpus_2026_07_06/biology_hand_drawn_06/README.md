# Photosynthetic Oxygen Release Across a Light Intensity Series

**Package:** `biology_hand_drawn_06`
**Subject:** AP Biology
**Answer type:** Hand-drawn graph response
**Source item:** `HDG-2026-P2-SER-002` (reused from the existing in-repo

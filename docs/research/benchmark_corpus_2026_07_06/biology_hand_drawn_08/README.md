# Water Movement in Model Cells Across External Solute Concentration

**Package:** `biology_hand_drawn_08`
**Subject:** AP Biology
**Answer type:** Hand-drawn graph response
**Source item:** `HDG-2026-P2-EST-001` (reused from the existing in-repo

# Side-by-Side Boxplots for Delivery Times by Route Type

**Package:** `statistics_hand_drawn_01`
**Subject:** AP Statistics
**Answer type:** Hand-drawn graph response
**Source item:** `APSTATS-HDG-2026-GRAPH-001` (reused from the existing in-repo

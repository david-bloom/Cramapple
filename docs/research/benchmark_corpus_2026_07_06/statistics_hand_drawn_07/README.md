# Segmented Bar Graph for Explanation Quality Before/After a Simulation Lesson

**Package:** `statistics_hand_drawn_07`
**Subject:** AP Statistics
**Answer type:** Hand-drawn graph response
**Source item:** `APSTATS-HDG-2026-GRAPH-008` (reused from the existing in-repo

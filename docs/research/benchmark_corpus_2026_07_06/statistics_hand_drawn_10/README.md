# Scatterplot of Screen Brightness and Battery Remaining

**Package:** `statistics_hand_drawn_10`
**Subject:** AP Statistics
**Answer type:** Hand-drawn graph response
**Source item:** `APSTATS-HDG-2026-GRAPH-011` (reused from the existing in-repo

...
Status: **in progress — 2 of 6 subjects complete**
...
The four subjects marked not attempted have no packet or proposal files yet. Each will be completed and validated as a whole before the next subject begins. Every proposal remains gated on independent cross-model QA and Product Owner approval under DECISION-0055 before serving students.

# Cramapple Agent Operating Model
...
The main conductor owns agent coordination, integrated recommendations, and publication of approved decisions. David owns final product decisions. Side agents provide evidence and proposed findings.
...
- Economics and operating-model analysis.
- Direct challenge to weak assumptions.
...
5. Decisions required from David or the relevant co-founder.

The Strategy Advisor may draft plans and decisions but must not present recommendations as approved decisions.

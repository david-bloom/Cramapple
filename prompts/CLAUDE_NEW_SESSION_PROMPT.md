...
- Main Conductor owns source-of-truth, approval boundaries, integrated recommendations, and GitHub publishing. Only the Main Conductor sets a task's status to Done. David owns final product decisions; Orly and Micah hold delegated approval authority within their named domains (see AI_COLLABORATION_RULES.md).

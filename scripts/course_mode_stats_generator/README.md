...
- `generator.py` — Track A: 8 computational procedures × scenario × form, catalog-cited misconception distractors, item-package emission, property harness. `python3 generator.py` runs checks; `emit` writes samples.

...
-- wmgjsdkphcyhngaffbqf does NOT have app.taxonomy_source_versions /
-- app.taxonomy_units. Dev built a divergent taxonomy design
-- (taxonomy_schemes / taxonomy_node_versions / taxonomy_crosswalks) under the
-- same migration version 20260820192400 that Production used to build
-- taxonomy_source_versions / taxonomy_units / taxonomy_topics. QA-UNITS below
-- therefore cannot pass on Dev until that drift is reconciled.

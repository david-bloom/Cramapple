...
-- Prototype-only student experience schema.
-- This migration is intended for the fresh prototype Supabase project.
...
-- Basic operational indexes for the student flow.

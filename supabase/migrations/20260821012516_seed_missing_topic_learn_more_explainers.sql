...
-- Ensure every published Topic Point Brief has a corresponding Learn More
-- explainer. Existing hand-authored explainers are preserved unless a matching
-- explainer row is missing.

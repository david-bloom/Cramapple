...
-- ---------------------------------------------------------------------------
-- ---------------------------------------------------------------------------
-- What source_payload carries, and what it points at instead of copying
--
-- Per row: the proposed topic code and unit, the builder's own confidence and needs_human flag, the
-- alternate code it considered, and for held rows the QA finding id, issue type and suggested fix.
--
-- It deliberately does NOT copy the proposal's `rationale` prose. That field is a template -- the
-- same sentence 118 times with the topic title interpolated -- and the authoritative copy is the
-- committed CSV. Each row instead carries `rationale_source`, a path to that file, so the full text
-- stays one lookup away in version control rather than duplicated 118 times in a jsonb column.
--
-- ---------------------------------------------------------------------------
...
--
-- Independently verified afterwards, by query rather than by trusting the migration's own guards:
--   118 rows written, all label_scope='coverage'
--   112 provisional_model each carrying exactly one topic; 6 held carrying none; 0 validated
--   0 rows with ANY of the five validation columns set, so 'validated' stays unreachable
--   primary_unit null and required_units empty on all 118
--   every written row belongs to a published Biology item; 0 Biology items left without a row
--   0 topic codes outside the closed list; 36 distinct topics used across 60 available
--   exactly one CURRENT coverage label per item; the 70 prior empty shells on published items
--     were superseded (70 of the 181 pre-existing Biology coverage rows belonged to published
--     items; the other 111 sit on items with no published version and were correctly untouched)
--   serving labels across ALL subjects unchanged at 2051 rows, and the in-transaction fingerprint
--     check over the whole serving layer passed
--
-- Held finding ids present and correct: TL-057, TL-058, TL-059, TL-060, TL-061, TL-062.
...
insert into m2_staging (
  ...
  needs_human, alt_topic_code, hold_issue_type, qa_finding_id, suggested_topic_code
) values
  ('b8c56de7-c28f-4eb2-86d4-96d9a9186400','5.3',5,'provisional_model','low',true,'5.4',null,null,null),
  ('905df3c1-d797-456c-8caf-cfdb3721b29e','6.2',6,'provisional_model','medium',false,'6.1',null,null,null),
  ('786c5b62-f352-4077-91bf-b2a788c152c0','7.5',7,'provisional_model','medium',false,'7.1',null,null,null),
  ('5dca442d-b798-4ce8-9b1a-03ccfaf7aecc','1.1',1,'held','low',true,'2.5','topic_misassigned','TL-061','2.7'),
  ('a1101c5f-7dfa-4899-b766-c8bdf3d1e366','3.2',3,'provisional_model','medium',false,'1.1',null,null,null),
  ('ccf9a896-ab8f-48b6-9f19-10c043ab14af','2.1',2,'provisional_model','medium',false,null,null,null,null),
  ('beb10310-b7f6-45fe-922c-b2586ac07677','2.1',2,'provisional_model','low',true,'3.5',null,null,null),
  ('4a84a371-50b8-47a1-8089-16ead0b41331','3.5',3,'provisional_model','medium',false,'3.3',null,null,null),
  ('3f243cab-1291-4bac-8b7a-17ca56aad92c','3.5',3,'provisional_model','medium',false,'3.3',null,null,null),
  ('f420df2b-d478-4795-b646-0f4a13a04b59','4.3',4,'provisional_model','medium',false,'4.2',null,null,null),
  ('65bd0d29-e854-416e-bd1c-3b5c966de99c','5.4',5,'provisional_model','medium',false,null,null,null,null),
  ('0880b181-fd70-4b8e-8659-48aeac65fff0','6.5',6,'provisional_model','medium',false,'6.6',null,null,null),
  ('6ee01c8f-000f-402c-b224-ada511355345','5.2',5,'provisional_model','low',true,'7.1',null,null,null),
  ('490a27e7-d446-4ee0-bb76-fda55d29f5d1','3.2',3,'provisional_model','low',true,'5.2',null,null,null),
  ('7e403aba-b29d-4d6f-9cc5-33cff23c2597','2.1',2,'provisional_model','medium',false,null,null,null,null),
  ('a0fa8005-6513-4521-8e4a-0581ac81cd7e','6.5',6,'provisional_model','medium',false,'6.6',null,null,null),
  ('eeda718e-35ea-4282-884d-a235e76acd6f','8.2',8,'provisional_model','medium',false,'2.5',null,null,null),
  ('ec8e7408-1f8a-44d9-9dbb-dd89eb8122b1','5.2',5,'provisional_model','medium',false,null,null,null,null),
  ('f07ecf14-7cfd-423a-80d1-f83d05d34ccb','3.3',3,'provisional_model','low',true,'3.5',null,null,null),
  ('0cb84009-f7a4-4315-975c-34a7fbf06e2b','2.1',2,'provisional_model','low',true,'6.3',null,null,null),
  ('15578bad-7da4-4a51-abde-595f5f9601d7','5.5',5,'provisional_model','low',true,'7.4',null,null,null),
  ('317c8f23-e810-4163-8f5f-f8ea0036c742','7.5',7,'provisional_model','medium',false,'2.2',null,null,null),
  ('b4249345-5510-4c46-b072-a1ea8219baa4','5.2',5,'provisional_model','low',true,'6.5',null,null,null),
  ('5924211d-ad3e-43cf-9574-f3d900b4f647','3.3',3,'provisional_model','low',true,'3.5',null,null,null),
  ('5055732c-6852-4429-8d71-57836d8c5226','2.1',2,'provisional_model','low',true,'2.2',null,null,null),
  ('c1e627a9-49f0-4265-96fd-08cdf7169343','2.8',2,'provisional_model','low',true,'4.4',null,null,null),
  ('c0d0ec3a-8b19-4ad4-b211-3a7083408b38','1.1',1,'provisional_model','medium',false,null,null,null,null),
  ('b76a09ff-aecf-4e87-a17b-5b04285a08e7','3.2',3,'provisional_model','medium',false,'1.1',null,null,null),
  ('a3b95a8c-b537-4f07-aab6-5e3a606d930b','1.1',1,'provisional_model','medium',false,'1.2',null,null,null),
  ('561eb0a2-a904-41dc-baee-b1b46f057dee','2.1',2,'provisional_model','medium',false,'4.6',null,null,null),
  ('a7fe6aa6-8d05-4db0-a6bf-b057f549a1ac','2.2',2,'provisional_model','low',true,'2.3',null,null,null),
  ('ea4f4f45-60ef-44c9-828b-dbf61892eff7','1.1',1,'provisional_model','low',true,'2.1',null,null,null),
  ('ee3aa8b2-c996-4f32-aad4-27cd68568a42','1.1',1,'provisional_model','low',true,'1.6',null,null,null),
  ('afd0854c-343d-4e37-a066-05f23d319e03','2.6',2,'provisional_model','medium',false,'1.7',null,null,null),
  ('dd5e062b-5328-479c-bf77-16dc207957f4','2.1',2,'provisional_model','low',true,'2.10',null,null,null),
  ('09a23a59-2ede-438d-b94f-3cbb3e12c8d0','2.5',2,'provisional_model','low',true,'2.8',null,null,null),
  ('7e09a039-a38b-4acf-aa67-fdcb8da6d26e','8.2',8,'provisional_model','medium',false,null,null,null,null),
  ('d2195299-b1b0-4ae9-a109-54fa4b53a846','1.7',1,'provisional_model','low',true,'2.1',null,null,null),
  ('ffb44beb-3467-4353-8b05-2715517d4cbb','1.1',1,'provisional_model','low',true,null,null,null,null),
  ('9e9936b4-9fa7-4e47-b6f9-7950388318ea','1.1',1,'provisional_model','low',true,null,null,null,null),
  ('c49484c4-5e3c-4c0c-a18d-e308055c6370','5.5',5,'provisional_model','low',true,null,null,null,null),
  ('d994c1b0-7951-4060-8053-1b4410b488b7','5.5',5,'provisional_model','low',true,null,null,null,null),
  ('b32b3a6d-ee7d-4720-b5ad-64547aebd892','2.1',2,'provisional_model','low',true,'2.10',null,null,null),
  ('c41250d8-93ec-43fd-b68e-6f157d52c0c8','6.1',6,'provisional_model','low',true,'6.3',null,null,null),
  ('dfa7018e-2ec0-409b-ae53-20895537ea68','2.2',2,'provisional_model','low',true,'3.2',null,null,null),
  ('149908e1-6c62-49d3-bae7-7ac23f12ce86','2.2',2,'provisional_model','low',true,'6.5',null,null,null),
  ('020fe264-1242-488a-aee5-9eb26d3b5faa','7.1',7,'provisional_model','low',true,'7.2',null,null,null),
  ('e3e2cd85-0071-4d37-800b-0cba0ae09c69','3.3',3,'provisional_model','low',true,'3.5',null,null,null),
  ('69c36745-2e64-4edd-a220-6b8935ed0a74','3.3',3,'provisional_model','low',true,'3.4',null,null,null),
  ('9e772ef8-410e-4269-a573-37aeb777833b','7.4',7,'provisional_model','low',true,'8.3',null,null,null),
  ('004fa02d-4b3a-42f1-9159-e909ded75d7f','1.1',1,'provisional_model','low',true,null,null,null,null),
  ('b29147fe-ca1c-4b33-b8c7-e8e6192220e8','4.5',4,'provisional_model','low',true,'4.6',null,null,null),
  ('bf484484-9ce9-45fc-ab45-49b88ae745e7','1.1',1,'held','low',true,'2.1','topic_misassigned','TL-062','2.7'),
  ('f906df10-9c94-4432-9e4f-968e185301ac','5.2',5,'provisional_model','medium',false,null,null,null,null),
  ('f96c2ad9-7bd0-4950-a9b0-d7492ea30803','2.2',2,'provisional_model','low',true,'3.1',null,null,null),
  ('f67ec85b-e2b0-4733-b891-c3e99e076f93','8.5',8,'provisional_model','low',true,null,null,null,null),
  ('835d8ce4-93e2-46d2-af6d-adcd4c2713f3','2.1',2,'provisional_model','medium',false,'1.1',null,null,null),
  ('e0278b91-cfc8-48ef-83b7-a9b4256ddf36','4.5',4,'provisional_model','low',true,'4.6',null,null,null),
  ('6d03e381-4f81-4f33-8804-7ea567f12330','1.1',1,'provisional_model','low',true,'1.4',null,null,null),
  ('ec200449-df12-4069-8a92-aea33feb36c9','6.6',6,'provisional_model','medium',false,'6.5',null,null,null),
  ('907a1813-1d45-4b4f-aff7-8382632ef127','1.1',1,'provisional_model','low',true,'2.1',null,null,null),
  ('80e917c2-fc85-4aa6-a7e7-1f37050922f8','5.5',5,'provisional_model','low',true,'7.1',null,null,null),
  ('5dfd441b-f01b-4dc4-b327-1fe05b12f432','5.2',5,'provisional_model','low',true,'6.5',null,null,null),
  ('c992e827-4720-4f1a-b2d4-924a9313e7b3','3.3',3,'provisional_model','low',true,'3.4',null,null,null),
  ('ffe8566d-7b98-4526-b58a-f37c4d8ededc','6.4',6,'provisional_model','low',true,'6.5',null,null,null),
  ('79cb5876-49bb-4d94-856d-414cd4c629b8','6.5',6,'provisional_model','low',true,'6.6',null,null,null),
  ('be78ce36-c01b-47d1-901f-7bf38caa0e7b','6.1',6,'provisional_model','low',true,'6.6',null,null,null),
  ('016e7347-2003-45de-9967-619544d691ca','1.1',1,'provisional_model','low',true,null,null,null,null),
  ('7640704b-6e1d-4bad-bc74-f3d194324805','7.7',7,'provisional_model','medium',false,'2.10',null,null,null),
  ('2c275bcc-2927-4910-83b6-fe61552a511b','7.1',7,'provisional_model','low',true,'7.2',null,null,null),
  ('ebcdd05b-73a4-49ca-9b2e-96f8bbdef234','6.1',6,'provisional_model','low',true,'7.6',null,null,null),
  ('87874651-60bb-40cc-a634-2ce196ad996d','3.2',3,'held','low',true,'8.4','uninformative_stem','TL-057',null),
  ('b738b319-8146-43d5-a2c4-5b292e1f1943','7.1',7,'held','low',true,'7.2','uninformative_stem','TL-058',null),
  ('001fef04-5272-4c9d-9d2b-cde19287bcc7','8.2',8,'held','low',true,null,'uninformative_stem','TL-059',null),
  ('3db8a97a-baaf-4ff4-9110-06dd4bc91892','8.3',8,'held','medium',false,'2.2','uninformative_stem','TL-060',null),
  ('ccf8a3b4-88a8-4ff7-9844-85769f949666','1.3',1,'provisional_model','low',true,'2.5',null,null,null),
  ('72b21db8-5964-4d58-aae4-94fca62e0224','1.1',1,'provisional_model','low',true,'1.7',null,null,null),
  ('ca5cc6ae-774b-4500-93db-e18bddd48335','7.12',7,'provisional_model','medium',false,null,null,null,null),
  ('7d731b39-b795-4b9c-9eea-f1f4a11c3c7e','2.1',2,'provisional_model','medium',false,null,null,null,null),
  ('cebc6511-86ef-48e7-a50b-5040fd59cc7f','2.7',2,'provisional_model','medium',false,null,null,null,null),
  ('a7f27476-2aff-455d-841d-e8cdc4cf47f8','2.5',2,'provisional_model','medium',false,null,null,null,null),
  ('bb7f82db-454f-4635-933c-c80567b31ff9','2.5',2,'provisional_model','medium',false,'2.3',null,null,null),
  ('3509fa2a-9e58-4a28-9dc5-547451fd78a4','2.5',2,'provisional_model','medium',false,null,null,null,null),
  ('43774df8-fcb5-4979-af3e-e99f22651151','2.1',2,'provisional_model','medium',false,'2.10',null,null,null),
  ('12b70712-b8e1-4c88-a199-1769d21716d8','2.1',2,'provisional_model','medium',false,'2.10',null,null,null),
  ('d64759de-72fc-4b0b-8f2a-1b6278df42d7','2.3',2,'provisional_model','medium',false,null,null,null,null),
  ('09a0df29-1248-48ca-b456-860e4ee96056','2.3',2,'provisional_model','medium',false,'3.2',null,null,null),
  ('e8cfa78c-80db-4f78-9c92-643e71e732a9','2.5',2,'provisional_model','medium',false,'2.1',null,null,null),
  ('f89cf634-d106-4e39-bd08-86bfcaee946d','4.1',4,'provisional_model','medium',false,null,null,null,null),
  ('925a8ee2-4d4f-46fa-acdf-b11ec4e4e01b','4.2',4,'provisional_model','low',true,'4.3',null,null,null),
  ('131394c0-26d6-48fd-8c30-563efe5e3d72','4.2',4,'provisional_model','low',true,'4.3',null,null,null),
  ('bb3560b1-27c2-4049-a23f-807b7c7e3336','3.3',3,'provisional_model','medium',false,'3.5',null,null,null),
  ('36f35384-d317-490c-9b64-e9a1c4092802','4.2',4,'provisional_model','low',true,'4.3',null,null,null),
  ('c3f31738-a35a-4fd8-979d-30ee38d2d9c7','4.2',4,'provisional_model','low',true,'4.3',null,null,null),
  ('8ef95e9f-c1a1-4b90-87d7-85658e941dc5','4.3',4,'provisional_model','medium',false,'4.2',null,null,null),
  ('7d91a66c-cbd1-4a21-ba80-afead502c7ca','4.5',4,'provisional_model','low',true,'4.6',null,null,null),
  ('fc5ad24a-56b1-4eb5-84ee-73790aa4a351','2.8',2,'provisional_model','low',true,'4.4',null,null,null),
  ('1511bcd7-7d6a-432c-837c-5fd5e2387522','4.2',4,'provisional_model','low',true,'4.3',null,null,null),
  ('3cd93461-f154-4d7f-8acb-2ca71620cc74','5.3',5,'provisional_model','low',true,'5.4',null,null,null),
  ('2beed8b1-f149-4acb-8b8c-46592bcb28f0','6.5',6,'provisional_model','low',true,'6.6',null,null,null),
  ('b60575d3-cd19-4336-9d7b-46bd84b27907','5.3',5,'provisional_model','low',true,'5.4',null,null,null),
  ('d0e17629-7083-4d2f-9ef6-9a76a36c3d40','5.3',5,'provisional_model','low',true,'5.4',null,null,null),
  ('c4908388-08d4-4274-935e-dfb393077cdc','1.6',1,'provisional_model','low',true,'6.1',null,null,null),
  ('2e2c66b7-a563-47eb-abc7-37683745700d','6.5',6,'provisional_model','medium',false,null,null,null,null),
  ('37917d44-45e8-438d-9b90-c6ddc460f704','6.5',6,'provisional_model','medium',false,null,null,null,null),
  ('de3013c9-bdc6-4994-bf79-523c9c49e791','6.5',6,'provisional_model','medium',false,'6.1',null,null,null),
  ('e4f47c41-420e-40dd-921f-343b0fb0b161','6.5',6,'provisional_model','medium',false,'6.6',null,null,null),
  ('9b2ef7ea-ae9b-4dc9-9a9c-417eb5eee455','6.5',6,'provisional_model','medium',false,'4.6',null,null,null),
  ('13a725ac-38ec-4d14-b061-ee4beec24c3d','6.8',6,'provisional_model','medium',false,'6.1',null,null,null),
  ('4b0b8c3f-126a-45b7-8deb-27c2baf47547','7.1',7,'provisional_model','low',true,'7.2',null,null,null),
  ('770859c9-7ac4-4351-b5f0-49bab8ea98b2','6.6',6,'provisional_model','low',true,'7.10',null,null,null),
  ('768cfadd-4205-46ed-85bd-1ed667fb1728','7.7',7,'provisional_model','medium',true,'1.1',null,null,null),
  ('dd29ea19-85a9-462b-a0b9-b969d861f6fa','7.1',7,'provisional_model','low',true,'7.2',null,null,null),
  ('667ee67f-c38d-4d05-9cae-b2aea500c097','8.5',8,'provisional_model','medium',false,'8.2',null,null,null),
  ('cdd0dc50-fef1-4fcb-aa9d-a0299b8845be','8.5',8,'provisional_model','medium',false,null,null,null,null),
  ('6c51e1d8-1b3a-4402-9b1c-c015560ee7fc','8.2',8,'provisional_model','medium',false,null,null,null,null),
  ('95f03e91-c50d-4b14-aaca-b554c86b752f','8.3',8,'provisional_model','medium',false,null,null,null,null),
  ('cbbba1c3-0859-45da-8d7d-8a99f12a55d6','2.1',2,'provisional_model','low',true,'3.2',null,null,null);
...
select
  ...
  jsonb_strip_nulls(jsonb_build_object(
    ...
    'rationale_source', 'docs/research/bio_stats_topic_tagging_2026_09_22/topic_labels_proposal.csv',
    'qa_disposition', case when s.disposition = 'held' then 'held_by_qa' else 'accepted_by_qa' end,
    'qa_finding_id', s.qa_finding_id,
    'hold_issue_type', s.hold_issue_type,
